If you are moving from Tumblr to Octopress, you might have seen the Jekyll posts importer(https://github.com/mojombo/jekyll/wiki/blog-migrations), btu it doesn't quite work for Octopress. 
